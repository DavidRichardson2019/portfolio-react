        ...
        <Grid container direction="column" justify="space-evenly" alignItems="center" className={classes.wrapper}>
          ...
          <Grid container direction={contentDirection} justify="space-evenly" alignItems="center" className={classes.content}>
            ...
            <div className={classes.aboutMeText}>
              <h3 className={classes.title}>Serial Hobbyist</h3>
              <p className={classes.paragraph}>For as long as I can remember I have followed my dad through many hobbies. When I was a child he was constantly buying and selling things getting in and out of many hobbies, it's who we are. The majority of our hobbies have been RC related, we started out racing RC cars, then we sold that stuff and got into RC planes, then we sold all of that and got into helicopters, that's when I found racing drones. After that I have been hooked on these drones, I am more into the freestyle side. I build, configure, fix, fly, and edit my footage for youtube, and I love it all. I've also been in and out of downhill longboarding for a long time, and my family is starting to get into off-road Jeeping.</p>
              <h3 className={classes.title}>Development History</h3>
              <p className={classes.paragraph}>I have been programming since around 7th grade, I started out programming HTML in a class at school. After that I was hooked, my method for a while was to just learn as much as possible. I went from language to language making as many projects as I could mostly following youtube videos. After a while I decided to start focusing more, I purchased a MacBook and started using Swift to create iOS apps. I used swift for a couple of years, trying to learn as much about it as I could and making as many projects as possible. After that I decided to experiment with React.js, I have since been working on grasping that.</p>
            </div>
          </Grid>
        </Grid>
      </div>
